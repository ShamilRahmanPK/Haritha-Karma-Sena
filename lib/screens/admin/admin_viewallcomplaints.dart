...
class ViewAllComplaintsAdmin extends StatefulWidget {
  String? uid;
  ViewAllComplaintsAdmin({Key? key, this.uid}) : super(key: key);

  @override
  State<ViewAllComplaintsAdmin> createState() => _ViewAllComplaintsAdminState();
}

class _ViewAllComplaintsAdminState extends State<ViewAllComplaintsAdmin> {
